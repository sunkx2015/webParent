...
Ext.define('Desktop.view.main.Settings', {
    ...
    createTree : function() {
        ...
        var tree = new Ext.tree.Panel({
            ...
            store: new Ext.data.TreeStore({
                model: 'Desktop.model.main.Wallpaper',
                root: {
                    text:'Wallpaper',
                    expanded: true,
                    children:[
    ...
    onSelect: function (tree, record) {
        ...
        if (record.data.img) {
            me.selected = 'Ext/resources/images/wallpapers/' + record.data.img;
        } else {
